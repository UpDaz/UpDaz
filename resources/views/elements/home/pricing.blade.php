    ...
    <div class="container flex flex-col gap-8 mx-auto md:gap-16">
        ...
        <div class="grid grid-cols-3">
            ...
            <div class="relative">
                ...
                <div
                    class="absolute w-[1px] top-1/2 h-[100%] -translate-y-1/2 left-0 bg-gradient-to-b from-transparent via-gray to-transparent ">
                </div>
                <div
                    class="absolute w-[1px] top-1/2 h-[100%] -translate-y-1/2 right-0 bg-gradient-to-b from-transparent via-gray to-transparent ">
                </div>
            </div>
