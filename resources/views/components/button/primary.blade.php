<div class="relative w-full">
    <{{ $tag }} {{ $attributes }}
        class="font-semibold border inline-block w-full @if ($small) px-4 py-2 text-sm @else px-6 py-3 @endif uppercase text-center border-yellow text-dark bg-yellow hover:bg-white {{ $classes }}">
        {{ $slot }}
    </{{$tag}}>
