<div id="sequences" class="w-full bg-blue px-8 md:px-16 py-16 md:py-24">
    <div class="container mx-auto flex items-center md:h-screen">
        <h1 class="hidden">
            Création de site internet sur mesure à Bordeaux
        </h1>
        <div class="-mt-24 grid grid-cols-1 md:grid-cols-2 flex items-center justify-between w-full">
            ...
            <div class="mt-32 md:mt-0 mb-12 md:mb-0">
