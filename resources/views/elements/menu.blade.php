...
<nav id="menu" 
  x-data="menu"
  class="sticky w-full bg-blue z-50 transition-all"
  :class="displayMenu ? 'top-0' : '-top-24'"
  @scroll.window="manageMenuDisplay();"
>
  <div class="container px-6 lg:px-16 py-4 md:py-6 flex flex-wrap justify-between items-center mx-auto">
    <a href="{{ route('home') }}" class="flex items-center" title="UpDaz">
        <img src="{{ asset('img/logo.svg') }}" class="mr-3 h-6 md:h-8" width="100" height="32" alt="UpDaz Logo" title="UpDaz" />
    </a>
