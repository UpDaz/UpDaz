    ...
    <div class="container mx-auto">
        <div class="flex flex-wrap items-center justify-between">
            <a href="{{ route('home') }}" class="flex items-center" title="UpDaz">
                <img src="{{ asset('img/logo.svg') }}" class="w-auto h-6 md:h-8" width="100" height="32"
                    alt="UpDaz Logo" title="UpDaz" />
            </a>
            <button @click.prevent="toggleMobileMenu()" aria-label="Ouvrir menu" type="button"
                class="inline-flex items-center p-2 ml-3 text-sm text-white md:hidden" aria-controls="mobile-menu"
                aria-expanded="false">
            ...
            <div x-bind:class="openMobileMenu ? '!left-0' : 'left-full'"
                ...
                <button @click.prevent="toggleMobileMenu()" type="button" aria-label="Fermer menu"
                    class="absolute text-sm text-white top-6 right-8 md:hidden" aria-controls="mobile-menu"
                    aria-expanded="false">
                ...
                <ul
                    ...
                    <li class="relative" x-data="{ openSubmenu: false }" @mouseleave="openSubmenu = false"
                    ...
                    <li class="hidden md:block">
                        <a href="https://fr.linkedin.com/in/matthieu-dazord" target="_blank" title="Linkedin"
                            class="block py-4 pl-3 pr-4 text-white bg-blue-700 md:py-2 md:bg-transparent md:p-0 dark:text-white hover:underline"
                            aria-current="page">
                            <img src="{{ asset('img/logos/white/linkedin.svg') }}" width="20" height="20"
                    ...
                    <li class="hidden md:block">
                        <a href="https://github.com/UpDaz" target="_blank" title="Github"
                            class="block py-4 pl-3 pr-4 text-white bg-blue-700 md:py-2 md:bg-transparent md:p-0 dark:text-white hover:underline"
                            aria-current="page">
                            <img src="{{ asset('img/logos/white/github.svg') }}" width="20" height="20"
