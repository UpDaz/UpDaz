<section id="services" class="px-8 py-4 border-gray-200 md:px-16 md:py-16 bg-pattern-2 sm:border-y">
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div
                class="flex flex-col h-full p-8 bg-white border-2 border-gray-200 border-opacity-50 rounded-lg sm:flex-row">
                <div
                    class="flex items-center justify-center flex-shrink-0 w-16 h-16 mx-auto mb-4 bg-gray-100 rounded-full md:inline-flex sm:mr-8 sm:mb-0 text-blue">
