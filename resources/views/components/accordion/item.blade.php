<div x-data='{ open: false }' class="relative flex flex-col">
    ...
    <div class="flex items-center justify-between gap-8 p-8 md:px-16 hover:bg-blue hover:cursor-pointer"
        @click="open = !open">
        <h3 class="font-normal md:text-lg font-text">
            {!! $title !!}
        </h3>
        <div>
    ...
    <div class="relative overflow-hidden transition-all duration-500"
        ...
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-1/4 border background border-gray h-[5px]"></div>
