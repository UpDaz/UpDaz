<div id="services" x-data="services" class="relative overflow-hidden bg-blue px-8 lg:px-16 py-16 lg:py-24">
    <img src="{{ asset('img/illustrations/services.svg') }}" class="absolute x-center y-center h-3/4 opacity-10" width="587" height="409" alt="Paquets" title="Arrière plan">
    <div class="container">
