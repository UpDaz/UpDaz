<section id="offres" class="px-8 py-8 border-gray md:px-16 md:py-16 sm:border-t">
    <div class="container flex flex-col gap-8 mx-auto md:gap-16">
        ...
        <div class="grid grid-cols-3">
            ...
            <x-price>
                <x-slot:title>
                    <span class="absolute text-xs tracking-widest uppercase top-2 right-4 text-yellow">Meilleur
                        choix</span>
