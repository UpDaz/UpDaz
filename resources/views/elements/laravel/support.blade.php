    ...
    <div class="container flex flex-col gap-8 mx-auto md:gap-16">
        ...
        <div class="grid grid-cols-1 gap-16 md:gap-x-8 md:gap-y-16 md:grid-cols-2">
            ...
            <x-skills.box>
                ...
                <x-slot:title>
                    <h3 class="text-lg font-medium title-font">Analyse et conseils de vos besoins</h3>
                </x-slot:title>
            </x-skills.box>
            ...
            <x-skills.box>
                ...
                <x-slot:title>
                    <h3 class="text-lg font-medium title-font">Digitalisation et numérisation de vos besoins</h3>
                </x-slot:title>
            </x-skills.box>
            ...
            <x-skills.box>
                ...
                <x-slot:title>
                    <h3 class="text-lg font-medium title-font">Intégration d'APIs RESTful et connexion à des ressources externes</h3>
                </x-slot:title>
            </x-skills.box>
            ...
            <x-skills.box>
                ...
                <x-slot:title>
                    <h3 class="text-lg font-medium title-font">Optimisation du référencement (SEO) et des performances</h3>
                </x-slot:title>
            </x-skills.box>
            ...
            <x-skills.box>
                ...
                <x-slot:title>
                    <h3 class="text-lg font-medium title-font">Mise en place de tunnel de conversion des visiteurs en prospect</h3>
                </x-slot:title>
            </x-skills.box>
            ...
            <x-skills.box>
                ...
                <x-slot:title>
                    <h3 class="text-lg font-medium title-font">Conception d'interface fluide, dynamique et engageante</h3>
                </x-slot:title>
            </x-skills.box>
