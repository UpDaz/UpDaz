...
use MarvinLabs\DiscordLogger\ServiceProvider as BaseServiceProvider;

class DiscordServiceProvider extends BaseServiceProvider
{
    /** @return void */
    ...
    protected function registerContainerBindings(): void
    {
        $this->app->bind(DiscordWebHook::class, static function (Container $app, $params) {
            ...
            return new CustomGuzzleWebHook($guzzle, $params['url']);
        });
    }
}
